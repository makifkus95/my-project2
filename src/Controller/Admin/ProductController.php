...
class ProductController extends Controller
{
    ...
    public function new(Request $request,CategotyRepository $categotyrepository ): Response
    {
        ...
        $catlist = $categotyrepository->findAll();

            $catname = $categotyrepository->findBy(['id' => 0 ]);
     ...
     */
    public function edit(Request $request, $id,Product $product,CategotyRepository $categotyrepository): Response
    {
        $catlist = $categotyrepository->findAll();

        if($product->getCategoryId()!=0){
            $catname = $categotyrepository->findOneBy(['id' => $product->getCategoryId()]);
        }else{
            $catname = array(
